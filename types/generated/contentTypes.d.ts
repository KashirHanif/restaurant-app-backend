...
export interface ApiRestaurantRestaurant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    number_of_tables: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiTableTable extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orders: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    publishedAt: Schema.Attribute.DateTime;
    qr_code_url: Schema.Attribute.String & Schema.Attribute.Required;
    restaurant: Schema.Attribute.Relation<
      'manyToOne',
      'api::restaurant.restaurant'
    >;
